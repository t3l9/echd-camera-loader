...
class LoginWindow(QWidget):
    ...
    def initUI(self):
        ...
        title.setStyleSheet("font-size: 15px; font-weight: 600; color: white; background: transparent; border: none;")
        ...
        auth_layout.setContentsMargins(Spacing.LG, Spacing.LG, Spacing.LG, Spacing.LG)
        auth_layout.setSpacing(Spacing.SM)

        lbl_auth = Label("🔐 Авторизация", "subheading")
        lbl_auth.setStyleSheet(f"font-size: 15px; font-weight: 700; color: {Colors.TEXT_MAIN}; border: none; background: transparent;")
        auth_layout.addWidget(lbl_auth)
        ...
        lbl_settings = Label("⚙️ Параметры", "subheading")
        lbl_settings.setStyleSheet(f"font-size: 15px; font-weight: 700; color: {Colors.TEXT_MAIN}; border: none; background: transparent;")
        ...
        areas_layout.setContentsMargins(Spacing.LG, Spacing.LG, Spacing.LG, Spacing.LG)
        areas_layout.setSpacing(Spacing.SM)
        
        # Заголовок с кнопкой
        areas_header = QHBoxLayout()
        lbl_areas = Label("📍 Районы", "subheading")
        lbl_areas.setStyleSheet(f"font-size: 15px; font-weight: 700; color: {Colors.TEXT_MAIN}; border: none; background: transparent;")
        areas_header.addWidget(lbl_areas)
        ...
        self.start_btn.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                    stop:0 {Colors.PRIMARY_DARK}, stop:1 #5B21B6);
            }}
