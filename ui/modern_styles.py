...
class Colors:
    ...
    PRIMARY_DARK = "#6D28D9"
    PRIMARY_PALE = "#EDE9FE"
    PRIMARY_PALE2 = "#F5F3FF"  # ещё светлее — для hover состояний

    # Белые и нейтральные
    WHITE = "#FFFFFF"
    BG_MAIN = "#F8F7FC"        # Очень светлый фиолетово-серый фон
    BG_CARD = "#FFFFFF"
    BG_HOVER = "#F1EFF9"       # Hover с лёгким фиолетовым оттенком

    # Текст
    TEXT_MAIN = "#1E1B2E"      # Тёмно-фиолетовый (не чёрный)
    TEXT_SECONDARY = "#6B7280"
    TEXT_MUTED = "#9CA3AF"
    TEXT_ON_PRIMARY = "#FFFFFF"

    # Границы
    BORDER = "#E8E5F0"         # Слегка фиолетовая граница
    BORDER_FOCUS = "#7C3AED"
...
class Styles:
    ...
    TAB = f"""
        ...
        QTabBar::tab:hover:!selected {{
            color: {Colors.TEXT_MAIN};
            background-color: {Colors.PRIMARY_PALE2};
            border-radius: {Spacing.RADIUS_SM}px {Spacing.RADIUS_SM}px 0 0;
        }}
    """
